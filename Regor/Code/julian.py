...
# number of observation night (total observation length)
Night = 17

# starting Julian time, each day of observation for SII
...
# ending Julian time, each day of observation for SII
...
# number of steps each day for average time Nd
def steps():
    steps = []
...
# save the starting, ending and steping for observation on each day
...
#It is usefull during the plot of observational orbit 
ds = []
for i in range(0, Night, 1):
