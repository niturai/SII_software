...
truth = [R_a,R_b]
print("Radius of both stars =",truth)

# observation Julian day 
jd = jd[::360]                           # have (121 shape) 6 minutes apart for Night of observation
