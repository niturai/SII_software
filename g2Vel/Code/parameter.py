...
dt = 36000                                # time step each 10 hours
nstep = 285289                         # number of time step
...
xs_2 = x[2,::slice]                              # x-coordinate of gamma velorum 1          
ys_2 = y[2,::slice]                              # y-coordinate of gamma velorum 1                         
ts = t[::slice]
