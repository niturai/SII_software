...
from intfer_rl import hbt, X, Y, gX, gY
...
gt1 = np.load("data/sig1.npy")
gtn1 = np.load("data/sig_noise1.npy")
...
plt.legend()
plt.savefig("data/fig/sgn_wrl.png")
plt.show()
...
plt.legend()
plt.savefig("data/fig/sgnoise_wrl.png")
plt.show()    
...
plt.ylabel('correlated Signal $g_w(u)$', fontsize=12)
plt.legend()
plt.savefig("data/fig/sgn_rl.png")
plt.show()
...
plt.ylabel('correlated Signal $g_w(u)$ with noise', fontsize=12)
plt.legend()
plt.savefig("data/fig/sgnoise_rl.png")
plt.show()    
...
for i in range(len(base)):
    ...
    plt.legend()
    plt.savefig("data/fig/comp" + str(i) + ".png")
    plt.show()
...
for i in range(len(base)):
    ...
    plt.title('baseline (E,N) = ' + '(' + str(east[i]) + ',' + str(north[i]) + ')')
    plt.legend()
    plt.savefig("data/fig/comp_noise" + str(i) + ".png")
    plt.show()
...
for i in range(len(base)):
    ...
    plt.colorbar()
    plt.gca().set_aspect('equal')
    plt.savefig("data/fig/cntr_comp" + str(i) + ".png")
    plt.show()
