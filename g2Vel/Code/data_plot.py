...
mdata = np.load("data_final/sig.npy")
sdata = np.load("data_final/sig_noise.npy")
...
plt.savefig("data_final/fig/nsignal_wrl.png")
plt.show()
...
plt.subplots_adjust(left=0.1, bottom=None, right=None, top=None, wspace=None, hspace=None)
plt.gcf().set_size_inches(18, 18)
plt.savefig("data_final/fig/signal_wrl.png")
plt.show()
