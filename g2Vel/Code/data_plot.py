...
mdata1 = np.load("data/sig1.npy")
sdata1 = np.load("data/sig_noise1.npy")
...
plt.savefig("data/fig/nsignal_wrl.png")
plt.show()
...
plt.subplots_adjust(left=0.1, bottom=None, right=None, top=None, wspace=None, hspace=None)
plt.gcf().set_size_inches(18, 18)
plt.savefig("data/fig/signal_wrl.png")
plt.show()
...
fig, ax = plt.subplots(6,sharex=True)
#fig.subtitle('Signal with Julian Day')
ax[0].plot(jd, sdata1[0], color='royalblue', label = (east[0], north[0]))
ax[0].legend(bbox_to_anchor=(0.85, 0.85))
ax[1].plot(jd, sdata1[1], color='green', label =(east[1], north[1]))
ax[1].legend(bbox_to_anchor=(0.85, 0.85))
ax[2].plot(jd, sdata1[2], color='red', label = (east[2], north[2]))
ax[2].legend(bbox_to_anchor=(0.85, 0.85))
ax[3].plot(jd, sdata1[3], color='purple', label = (east[3], north[3]))
ax[3].legend(bbox_to_anchor=(0.85, 0.85))
ax[4].plot(jd, sdata1[4], color='brown', label = (east[4], north[4]))
ax[4].legend(bbox_to_anchor=(0.85, 0.85))
ax[5].plot(jd, sdata1[5], color='darkorange', label = (east[5], north[5]))
ax[5].legend(bbox_to_anchor=(0.85, 0.85))
fig.text(0.5, 0.04, 'Julian Observation Day', ha='center', fontsize=30)
fig.text(0.01, 0.5, 'Correlated Signal According to baseline with noise', va='center', rotation='vertical', fontsize=30)
plt.subplots_adjust(left=0.1, bottom=None, right=None, top=None, wspace=None, hspace=None)
plt.gcf().set_size_inches(18, 18)
plt.savefig("data/fig/nsignal_rl.png")
plt.show()
...
fig, ax = plt.subplots(6,sharex=True)
#fig.subtitle('Signal with Julian Day')
ax[0].plot(jd, mdata1[0], color='royalblue', label = (east[0], north[0]))
ax[0].legend(bbox_to_anchor=(0.85, 0.85))
ax[1].plot(jd, mdata1[1], color='green', label =(east[1], north[1]))
ax[1].legend(bbox_to_anchor=(0.85, 0.85))
ax[2].plot(jd, mdata1[2], color='red', label = (east[2], north[2]))
ax[2].legend(bbox_to_anchor=(0.85, 0.85))
ax[3].plot(jd, mdata1[3], color='purple', label = (east[3], north[3]))
ax[3].legend(bbox_to_anchor=(0.85, 0.85))
ax[4].plot(jd, mdata1[4], color='brown', label = (east[4], north[4]))
ax[4].legend(bbox_to_anchor=(0.85, 0.85))
ax[5].plot(jd, mdata1[5], color='darkorange', label = (east[5], north[5]))
ax[5].legend(bbox_to_anchor=(0.85, 0.85))
fig.text(0.5, 0.04, 'Julian Observation Day', ha='center', fontsize=30)
fig.text(0.01, 0.5, 'Correlated Signal According to baseline', va='center', rotation='vertical', fontsize=30)
plt.subplots_adjust(left=0.1, bottom=None, right=None, top=None, wspace=None, hspace=None)
plt.gcf().set_size_inches(18, 18)
plt.savefig("data/fig/signal_rl.png")
plt.show()
