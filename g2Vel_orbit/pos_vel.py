...
def getposvel(fname,now=2023):
    ...
    c = 299792458
    yr = 86400*365.25                                       # one year to seconds
    ...
    for n in range(1,N): 
        ...
        mean_an = (now-ep)/P * 2*pi                         # mean anomaly (in radian) if (now-ep) and p in yr or second
        P *= yr                                             # period in second
