...
np.save("data3/xt",xt)
np.save("data3/yt",yt)
np.save("data3/sig",smdata(0,lam,lam1))
np.save("data3/sig_noise",smdata(sigma,lam,lam1))
np.save("data3/sig1",smdata(0,lam1,lam1))
np.save("data3/sig_noise1",smdata(sigma,lam1,lam1))
...
if __name__ == "__main__": 
    ...
    out = open('data3/dres_wrl.pkl','wb')
